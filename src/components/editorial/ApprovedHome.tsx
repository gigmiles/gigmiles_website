...
export const TOUR_SCREENS: TourScreen[] = [
  ...
  {id:'wrap',tag:'FREE',figure:{value:192,prefix:'$',caption:'What you kept today, as a story you can share'},title:'Your day, as a story',body:'At the end of a day or a week, GigMiles writes the wrap: what you kept, what the drive cost, your rate. One tap to share it.',image:'tour-wrap.webp',alt:'Example GigMiles daily wrap share card: Steady Hustler badge, Sep 24, 2026; What I kept $192 from $235 gross; hours on the road 8h; miles tracked 105.0; costs, fuel to wear and tear, $43; net per hour $24; a Share my day button below. Example inputs, not a customer’s earnings.'},
