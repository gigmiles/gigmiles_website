...
export const TOUR_SCREENS: TourScreen[] = [
  {id:'home',tag:'FREE',figure:{value:192,prefix:'$',caption:'Net today, from $235 gross'},title:'Today’s number, after costs',body:'Net after vehicle costs and an estimated tax set-aside, for today and this week.',image:'tour-home.webp',alt:'Example GigMiles home screen with Today selected: Net Income $192 from $235 gross and $43 estimated costs; 105.0 miles, 8 hours, 1 trip, $24 per hour. Example inputs on a 2023 Toyota Prius in California, not a customer’s earnings.'},
  {id:'split',tag:'FREE',figure:{value:105,decimals:1,suffix:' mi',caption:'One shift, split across three apps'},title:'Each app gets its own miles',body:'Switch apps mid-shift, or split the shift afterwards. Every block keeps its own time, miles and earnings — so the deduction lands on the app you were driving for, not the first one you opened.',image:'tour-split.webp',alt:'Example GigMiles split-by-platform screen: one shift from 9:00 AM to 5:00 PM divided into DoorDash (9:00 to 12:30, 3h 30m, 46.6 miles), Uber Eats (12:30 to 3:00, 2h 30m, 32.0 miles) and Instacart (3:00 to 5:00, 2h 00m, 26.5 miles), 105.0 miles in total, with the two 10-minute stops marked where the switches happened. Example inputs, not a customer’s shift.'},
  {id:'plan',tag:'PRO',figure:{value:4523,prefix:'$',caption:'Gross to aim for, from $2,400 of living costs'},title:'A target that starts from your rent',body:'Living costs, a buffer and a savings goal become the net you need, then the gross to aim for by week, by day, by hour. Today’s number says whether you are on pace.',image:'tour-plan.webp',alt:'Example GigMiles Your plan screen: net today $192 of a $115 target, target reached; required income per month from $2,400 living costs, a 10% buffer of $240 and a $300 savings target is $2,940 net, plus 35% for costs and tax set-aside ($1,583), so the gross to aim for is $4,523: $686 per week, $114 per work day, $14 per hour. Example inputs, not a customer’s plan.'},
  {id:'tax',tag:'FREE · EXPORT IS PRO',figure:{value:162,prefix:'$',caption:'Estimated tax to set aside, Q3 2026'},title:'Tax center, on screen',body:'Self-employment, federal and state estimates with a Schedule C worksheet. PDF and CSV export for your tax professional is Pro.',image:'tour-tax.webp',alt:'Example tax estimate breakdown for Q3 2026: estimated tax for preparation $162 (self-employment $152, federal $0, state $10) on $1,648 gross with a $583 mileage deduction over 767 miles, single filer. Estimates only, not tax advice.'},
]
