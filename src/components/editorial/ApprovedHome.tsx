...
export const TOUR_SCREENS: TourScreen[] = [
  ...
  {id:'split',tag:'FREE',figure:{value:105,decimals:1,suffix:' mi',caption:'One shift, split across three apps'},title:'Each platform gets its own miles',body:'Switch platforms mid-shift, or split the shift afterwards. Every block keeps its own time, miles and earnings, so the deduction lands on the platform you were driving for.',image:'tour-split.webp',alt:'Example GigMiles split-by-platform screen: one shift from 9:00 AM to 5:00 PM divided into DoorDash (9:00 to 12:30, 3h 30m, 46.6 miles), Uber Eats (12:30 to 3:00, 2h 30m, 32.0 miles) and Instacart (3:00 to 5:00, 2h 00m, 26.5 miles), 105.0 miles in total, with the two 10-minute stops marked where the switches happened. Example inputs, not a customer’s shift.'},
  {id:'plan',tag:'PRO',figure:{value:4523,prefix:'$',caption:'Gross to aim for, from $2,400 of living costs'},title:'A target that starts from your rent',body:'Enter your living costs and your work days. GigMiles turns them into the net you need and the gross to aim for, and shows your pace by day, week and month.',image:'tour-plan.webp',alt:'Example GigMiles Your plan screen: net today $192 of a $115 target, target reached; required income per month from $2,400 living costs, a 10% buffer of $240 and a $300 savings target is $2,940 net, plus 35% for costs and tax set-aside ($1,583), so the gross to aim for is $4,523: $686 per week, $114 per work day, $14 per hour. Example inputs, not a customer’s plan.'},
