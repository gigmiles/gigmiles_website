...
export const TOUR_SCREENS: TourScreen[] = [
  ...
  {id:'shifts',tag:'FREE',figure:{value:1939,decimals:1,suffix:' mi',caption:'Logged this year, across 156 hours'},title:'Each shift, on record',body:'Hours and miles by day, with what you earned. Edit a shift, add one you forgot, undo a delete.',image:'tour-shifts.webp',alt:'Example shift history on the year view: $4,169.15 gross, $3,395.16 net, 1,939.0 miles and 156 hours this year, then day cards for September and August with platform labels. Example inputs, not a customer’s earnings.'},
  ...
  {id:'insights',tag:'PRO',title:'Insights by platform',body:'Dollars per hour and per mile by platform, trend charts and a what-if mileage simulator.',image:'tour-insights.webp',alt:'Example Insights screen (Pro): a monthly gross and net profit trend across six months, a profit-per-hour and profit-per-mile trend, and an earnings-versus-expenses breakdown. Example inputs, not a customer’s earnings.'},
]
