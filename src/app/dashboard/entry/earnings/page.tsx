        ...
        <div className="max-w-4xl mx-auto space-y-10 animate-fade-in pb-20">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="font-display text-4xl font-bold tracking-tight text-slate-900 dark:text-slate-50">Add Earnings</h1>
                        <p className="text-muted-foreground">Log your platform earnings for accurate tracking.</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div className="flex items-center justify-end gap-4 pt-6">
                    ...
                    <Button
                        ...
                        disabled={loading}
                    >
                        {loading ? 'Processing...' : 'Save Earnings'}
                    </Button>
                </div>
            </form>
        </div>
